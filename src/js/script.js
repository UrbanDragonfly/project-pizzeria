...

{
  ...
  class AmountWidget{
    ...
    setValue(value){
      ...
      /* TODO: Add validation */
      if(thisWidget.value !== newValue && !isNaN(newValue) && settings.amountWidget.defaultMax >= newValue && settings.amountWidget.defaultMin <= newValue){
  ...
  class Cart {
    ...
    add(menuProduct){
      ...
      thisCart.update();
      console.log('add', thisCart.products);
    }
